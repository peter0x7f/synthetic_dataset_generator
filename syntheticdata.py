...
def overlay_png_on_images(base_folder, output_folder, baseimgx, baseimgy, scalemin, scalemax, class_id):
    ...
    for file_name in overlay_path_array:
        ...
        overlay_image_array.append(overlay_image)

    for filename in os.listdir(base_folder)[:1000]:
        if filename.lower().endswith(('png', 'jpg', 'jpeg')):
            ...
            for i in range(1):
                ...
                overlay_img = random.choice(overlay_image_array)
...
base_directory = r"original_images"  # Folder where original images are located
output_directory = r"synth_dataset"  # Folder where new images should be placed
# Change values based on your datasets
overlay_png_on_images(base_directory, output_directory, 1280, 720, 0.07, 0.25, 0)
